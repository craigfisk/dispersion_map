...
class DefaultBackendViewTests(TestCase):
    ...
    def test_activation_expired(self):
        ...
        #CF20130922 from https://bitbucket.org/ubernostrum/django-registration/src/ab21a26ef6a08b661401d141b8e71f8d5b608970/registration/tests/default_backend.py
        self.assertEqual(profile.activation_key, resp.context['activation_key'])
